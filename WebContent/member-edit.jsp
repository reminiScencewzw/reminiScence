                ...
                <form class="layui-form" method="post">
                    <div class="layui-form-item" style="margin:0 auto;width:60%;">
                        <label for="motif" class="layui-form-label">
                            <span class="x-red">*</span>主题名:</label>
                    ...
                    <div class="layui-form-item" style="text-align:center;">
                        <button class="layui-btn" lay-filter="add" lay-submit=""style="width:21%;">确认更改</button></div>
                </form>
            </div>
        </div>
    </body>
	...
	layui.use(['form', 'layer','jquery'],
            function() {
                ...
                form.on('submit(change)',
                    ...
                    location.href = "controller.jsp?type=change&motifName="+data.field.motif;
                    //关闭当前frame
                    xadmin.close();
